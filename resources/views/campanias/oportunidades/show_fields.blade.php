...
<div class="form-group">
    ...
    <p>{{ $oportunidad->justificacion_estado_campania_id }}</p>
</div>
...
<div class="form-group">
    ...
    <p>{{ $oportunidad->adicion_manual }}</p>
</div>
