...
<li id="entidades" class="treeview opcion-menu menu-abuelo">
    <a class="app-menu__item" href="#"><i class="fa fa-building"></i><span>Entidades</span></a>
    <ul class="treeview-menu">        
        <li id="entidades-parametros" class="treeview opcion-menu menu-padre">
            <a  class="app-menu__item" href="#"><i class="fa fa-circle-o"></i><span>Parámetros</span></a>
            <ul class="treeview-menu">
                <li id="entidades-actividades-economicas" class="treeview-item opcion-menu menu-hijo">
                ...
                <li id="entidades-categorias-actividad-economica" class="treeview-item opcion-menu menu-hijo">
...
<li id="formaciones" class="treeview opcion-menu menu-abuelo">
    <a class="app-menu__item" href="#"><i class="fa fa-graduation-cap"></i><span>Formaciones</span></a>
    <ul class="treeview-menu">
        <li id="formaciones-parametros" class="treeview opcion-menu opcion-menu-padre">
            <a href="#"><i class="fa fa-circle-o"></i><span>Parámetros</span></a>
            <ul class="treeview-menu">
                <li id="formaciones-campos-educacion" class="treeview-item opcion-menu menu-hijo">
                    <a href="{{ route('formaciones.camposEducacion.index') }}"><i class="fa fa-circle-o"></i><span>@lang('models/camposEducacion.plural')</span></a>
                </li>   
                <li id="formaciones-categorias-campo-educacion" class="treeview-item opcion-menu menu-hijo">
                ...
                <li id="formaciones-niveles-formacion" class="treeview-item opcion-menu menu-hijo">
...
<li id="funnels" class="treeview opcion-menu menu-abuelo">
