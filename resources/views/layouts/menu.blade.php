...
<li id="contactos" class="treeview opcion-menu menu-abuelo">
    ...
    <ul class="treeview-menu">
        <li id="contactos-parametros-basicos" class="treeview opcion-menu menu-padre">
            ...
            <ul class="treeview-menu">
                <li id="parametros.estadosCiviles" class="treeview-item opcion-menu menu-hijo">
        ...
        <li id="contactos-parametros-relacionales" class="treeview opcion-menu menu-padre">
            ...
            <ul class="treeview-menu">
                <li id="parametros.actitudesServicio" class="treeview-item opcion-menu menu-hijo">
                ...
                <li id="parametros.actividadesOcio" class="treeview-item opcion-menu menu-hijo">
                ...
                <li id="parametros.estadosDisposicion" class="treeview-item opcion-menu menu-hijo">
                ...
                <li id="parametros.mediosComunicacion" class="treeview-item opcion-menu menu-hijo">
...
<li id="entidades" class="treeview opcion-menu menu-abuelo">
    ...
    <ul class="treeview-menu">        
        <li id="entidades-parametros" class="treeview opcion-menu menu-padre">
            ...
            <ul class="treeview-menu">
                <li id="entidades.actividadesEconomicas" class="treeview-item opcion-menu menu-hijo">
                ...
                <li id="entidades.categoriasActividadEconomica" class="treeview-item opcion-menu menu-hijo">
                ...
                <li id="entidades.tiposOcupacion" class="treeview-item opcion-menu menu-hijo">
...
<li id="formaciones" class="treeview opcion-menu menu-abuelo">
    ...
    <ul class="treeview-menu">
        <li id="formaciones-parametros" class="treeview opcion-menu opcion-menu-padre">
            ...
            <ul class="treeview-menu">
                <li id="formaciones.camposEducacion" class="treeview-item opcion-menu menu-hijo">
                    <a href="{{ route('formaciones.camposEducacion.index') }}"><i class="fa fa-circle-o"></i><span>@lang('models/camposEducacion.plural')</span></a>
                </li>   
                <li id="formaciones.categoriasCampoEducacion" class="treeview-item opcion-menu menu-hijo">
                ...
                <li id="formaciones.nivelesFormacion" class="treeview-item opcion-menu menu-hijo">
