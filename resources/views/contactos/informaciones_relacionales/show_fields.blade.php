...
<div class="form-group">
    ...
    <p>{{ $informacionRelacional->autoriza_comunicacion }}</p>
</div>
...
<div class="form-group">
    ...
    <p>{{ $informacionRelacional->actualizacion_autoriza_comunicacion }}</p>
</div>
