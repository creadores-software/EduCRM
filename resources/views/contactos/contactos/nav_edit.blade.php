<ul class="nav nav-tabs">
    ...
    <li class="{{ (request()->is('contactos/informacionesRelacionales*')) ? 'active' : '' }}">
        <a href="{{ route('contactos.informacionesRelacionales.edit',$idRelacional) }}"><i class="fa fa-thumbs-up"></i> Relacional</a></li>
    <li class="{{ (request()->is('contactos/informacionesAcademicas*')) ? 'active' : '' }}">
        <a href="{{ route('contactos.informacionesAcademicas.index',$idContacto) }}"><i class="fa fa-graduation-cap"></i> Académica</a></li>
    <li class="{{ (request()->is('contactos/informacionesLaborales*')) ? 'active' : '' }}">
        <a href="{{ route('contactos.informacionesLaborales.index',$idContacto) }}"><i class="fa fa-briefcase"></i> Laboral</a></li>
    <li class="{{ (request()->is('contactos/parentescos*')) ? 'active' : '' }}">
        <a href="{{ route('contactos.parentescos.index',$idContacto) }}"><i class="fa fa-users"></i> Familiar</a></li>
    <li class="">
