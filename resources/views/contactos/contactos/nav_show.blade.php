<ul class="nav nav-tabs">
    ...
    <li class="{{ (request()->is('contactos/informacionesRelacionales*')) ? 'active' : '' }}">
        <a href="{{ route('contactos.informacionesRelacionales.show',$idRelacional) }}"><i class="fa fa-thumbs-up"></i> Relacional</a></li>
    ...
    <li class="{{ (request()->is('contactos/informacionesLaborales*')) ? 'active' : '' }}">
        <a href="{{ route('contactos.informacionesLaborales.index',['idContacto'=>$idContacto,'soloVista'=>true]) }}"><i class="fa fa-briefcase"></i> Laboral</a></li>
    <li class="{{ (request()->is('contactos/parentescos*')) ? 'active' : '' }}">
        <a href="{{ route('contactos.parentescos.index',['idContacto'=>$idContacto,'soloVista'=>true]) }}"><i class="fa fa-users"></i> Familiar</a></li>
    <li class="">
