...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'email'=>'Correo',
        'entidad_id' => 'Entidad',
        'equipo_mercadeo_id' => 'Equipo de Mercadeo',
        'estado_campania_id' => 'Estado',
        'estado_civil_id' => 'Estado Civil',
        'estado_disposicion_id' => 'Estado de Disposición',
        'estado_interaccion_id' => 'Estado de Interaccion',
        'estatus_lealtad_id' => 'Estatus de Lealtad',
        'estatus_usuario_id' => 'Estatus de Usuario',
        'estilo_vida_id' => 'Estilo de Vida',
        'facultad_id' => 'Facultad',
        'formacion_id' => 'Formación',
        'frecuencia_uso_id' => 'Frecuencia de Uso',
        'generacion_id' => 'Generación',
        'genero_id' => 'Genero',
        'informacion_relacional_id' => 'Información Relacional',
        'jornada_id' => 'Jornada',
        'justificacion_estado_campania_id' => 'Razón de Estado',
        'lugar_id' => 'Ubicación',
        'maximo_nivel_formacion_id' => 'Máximo Nivel de Formación',
        'medio_comunicacion_id' => 'Medio de Comunicación',
        ...
        'tipo_interaccion_id' => 'Tipo de Interaccion',
