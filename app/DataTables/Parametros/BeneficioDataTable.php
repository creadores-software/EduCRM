...
class BeneficioDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'parametros.beneficios.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Beneficio $model
    ...
    {
        return [
            'nombre' => new Column(['title' => __('models/beneficios.fields.nombre'), 'data' => 'nombre']),
    ...
    {
        return 'beneficios_' .  date("Ymd_His");
    }
}
