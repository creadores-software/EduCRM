...
class FrecuenciaUsoDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\FrecuenciaUso $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(FrecuenciaUso $model)
    {
    ...
    {
        return [
            'nombre' => new Column(['title' => __('models/frecuenciasUso.fields.nombre'), 'data' => 'nombre']),
