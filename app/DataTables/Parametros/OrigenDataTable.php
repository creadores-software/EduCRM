...
class OrigenDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\Origen $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Origen $model)
    {
    ...
    {
        return [
            'nombre' => new Column(['title' => __('models/origenes.fields.nombre'), 'data' => 'nombre']),
