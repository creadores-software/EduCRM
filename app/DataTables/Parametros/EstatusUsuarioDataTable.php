...
class EstatusUsuarioDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\EstatusUsuario $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(EstatusUsuario $model)
    {
    ...
    {
        return [
            'nombre' => new Column(['title' => __('models/estatusUsuario.fields.nombre'), 'data' => 'nombre']),
