...
class PeriodicidadDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\Periodicidad $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Periodicidad $model)
    {
    ...
    {
        return [
            'nombre' => new Column(['title' => __('models/periodicidades.fields.nombre'), 'data' => 'nombre']),
